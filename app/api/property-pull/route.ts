...
Rules:
- price_min / price_max must be plain integers in INR (no symbols, no commas). Convert: "45 Lakh" → 4500000, "1.5 Cr" → 15000000, "₹35L" → 3500000.
- bhk must be a comma-separated string of numbers only, e.g. "2,3" or "3,4".
